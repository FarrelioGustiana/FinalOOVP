package com.restaurant.showMenu;
...
public class showMenu extends javax.swing.JFrame {
    ...
    public void showCategoriesInList() {
        ...
        for (Categories category : categories) {
            model.addElement(category.getName().toUpperCase());
        }
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(3, 172, 14));
        jPanel1.setPreferredSize(new java.awt.Dimension(220, 500));

        categoriesList.setBackground(new java.awt.Color(3, 172, 14));
        categoriesList.setFont(new java.awt.Font("Dialog", 1, 24)); // NOI18N
        categoriesList.setForeground(new java.awt.Color(255, 255, 255));
